...
// Function definition of writing to database
...
static int transfer(string username,int accountNo,string tarName,string tarSurname, int value){
    ...
    // tarName , tarSurname means target person

    // Function of uppercase
...
// Reading datas from database and operation centre
static void addValuesFromTxt(){

    Person * arrayPerson;
    arrayPerson = dataBase();
    // Creating empty infos
    ...
    if ( dosyaOku.is_open() ){
        ...
        for(int i=0;i<6;i++){
            // Assigning person infos from database to empty infos 
...
//Reading changed database and writing new database to same .txt file
static void addValuesToTxt(){
    Person * arrayPerson;
    arrayPerson = dataBase();
    ...
    string userName,name,surname,password,bankaName;
    int hesapNo,paraValue;
    //::trunc for clearing database
    fstream dosyaOku("database.txt",ios::out | ios::trunc);
    string satir="";
    ...
    if ( dosyaOku.is_open() ){
        ...
        for(int i=0;i<6;i++){
            // Assigning filled infos to person infos
            ...
            // .txt clearing
            dosyaOku.close();
            // Writing new values to database .txt file
            fstream dosyaOku("database.txt",ios::app);
